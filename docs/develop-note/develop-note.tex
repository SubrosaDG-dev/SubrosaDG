...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    \draw[thick] plot [smooth,tension=0.8] coordinates { (3,1) (1.8,1.8) (1,3) };
    ...
    \draw[-latex,thick] (1.8,1.8) -- (2.5,2.5) node[below right]{$\mathbf{n}$};
    \draw[-latex,thick] (2.5,2.5) -- (3,3) node[below right]{$x$};
    \draw[-latex,thick] (1.8,1.8) -- (1,2.6) node[below=2pt]{$y$};
  \end{tikzpicture}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    \draw[thick] (0,3) -- (3,0);
    \draw[-latex,thick] (0,0) -- (4,0) node[right]{$\xi$};
    \draw[-latex,thick] (0,0) -- (0,4) node[right]{$\eta$};
    ...
    \draw[thick] plot [smooth,tension=0.8] coordinates { (7,1) (8,2) (10,3) };
    \draw[thick] plot [smooth,tension=0.8] coordinates { (10,3) (9,4) (7,5) };
    \draw[thick] plot [smooth,tension=0.8] coordinates { (7,5) (6,3) (7,1) };
    \draw[thick,-latex] (8,0) -- (9,0) node[right]{$x$};
    \draw[thick,-latex] (8,0) -- (8,1) node[right]{$y$};

    \draw (3,3) node[below right]{$\mathbf{x}(\xi,\eta)$};
    \draw[thick,-latex] plot [smooth,tension=0.8] coordinates { (0.5,1.5) (3,3) (7,4) };
  \end{tikzpicture}
\end{figure}
...
\begin{equation}
  [\mathbf{J}](\xi,\eta,\zeta)=\dfrac{\partial(x,y,z)}{\partial(\xi,\eta,\zeta)}=\begin{bNiceMatrix}
    \dfrac{\partial x}{\partial \xi}&\dfrac{\partial x}{\partial \eta}&\dfrac{\partial x}{\partial \zeta}\\
    \dfrac{\partial y}{\partial \xi}&\dfrac{\partial y}{\partial \eta}&\dfrac{\partial y}{\partial \zeta}\\
...
and $\hat{\nabla}$ is the gradient operator in the reference element. The determinant of the Jacobian matrix $|\mathbf{J}|$ can be obtained by the following formula:
\begin{equation}
  |\mathbf{J}|(\xi,\eta,\zeta)=\dfrac{\partial x}{\partial \zeta}\dfrac{\partial y}{\partial \xi}\dfrac{\partial z}{\partial \eta}-\dfrac{\partial x}{\partial \xi}\dfrac{\partial y}{\partial \zeta}\dfrac{\partial z}{\partial \eta}-\dfrac{\partial x}{\partial \zeta}\dfrac{\partial y}{\partial \eta}\dfrac{\partial z}{\partial \xi}+\dfrac{\partial x}{\partial \eta}\dfrac{\partial y}{\partial \zeta}\dfrac{\partial z}{\partial \xi}+\dfrac{\partial x}{\partial \xi}\dfrac{\partial y}{\partial \eta}\dfrac{\partial z}{\partial \zeta}-\dfrac{\partial x}{\partial \eta}\dfrac{\partial y}{\partial \xi}\dfrac{\partial z}{\partial \zeta},
\end{equation}
and the Jacobian inverse matrix $[\mathbf{J}]^{-1}$ can be obtained by the following formula:
\begin{equation}
  [\mathbf{J}]^{-1}(\xi,\eta,\zeta)=\dfrac{\partial(\xi,\eta,\zeta)}{\partial(x,y,z)}=\dfrac{1}{|\mathbf{J}|}\begin{bNiceMatrix}
    \dfrac{\partial y}{\partial \eta}\dfrac{\partial z}{\partial \zeta}-\dfrac{\partial y}{\partial \zeta}\dfrac{\partial z}{\partial \eta}&\dfrac{\partial x}{\partial \zeta}\dfrac{\partial z}{\partial \eta}-\dfrac{\partial x}{\partial \eta}\dfrac{\partial z}{\partial \zeta}&\dfrac{\partial x}{\partial \eta}\dfrac{\partial y}{\partial \zeta}-\dfrac{\partial x}{\partial \zeta}\dfrac{\partial y}{\partial \eta}\\
    \dfrac{\partial y}{\partial \zeta}\dfrac{\partial z}{\partial \xi}-\dfrac{\partial y}{\partial \xi}\dfrac{\partial z}{\partial \zeta}&\dfrac{\partial x}{\partial \xi}\dfrac{\partial z}{\partial \zeta}-\dfrac{\partial x}{\partial \zeta}\dfrac{\partial z}{\partial \xi}&\dfrac{\partial x}{\partial \zeta}\dfrac{\partial y}{\partial \xi}-\dfrac{\partial x}{\partial \xi}\dfrac{\partial y}{\partial \zeta}\\
    \dfrac{\partial y}{\partial \xi}\dfrac{\partial z}{\partial \eta}-\dfrac{\partial y}{\partial \eta}\dfrac{\partial z}{\partial \xi}&\dfrac{\partial x}{\partial \eta}\dfrac{\partial z}{\partial \xi}-\dfrac{\partial x}{\partial \xi}\dfrac{\partial z}{\partial \eta}&\dfrac{\partial x}{\partial \xi}\dfrac{\partial y}{\partial \eta}-\dfrac{\partial x}{\partial \eta}\dfrac{\partial y}{\partial \xi}
  \end{bNiceMatrix}.
\end{equation}
We can use some auxiliary variables to compute the inverse matrix and determinant of the Jacobian matrix, which are defined as
\begin{equation}
  \mathbf{a}_{\xi}=\mathbf{x}_{\eta}\times\mathbf{x}_{\zeta},\quad \mathbf{a}_{\eta}=\mathbf{x}_{\zeta}\times\mathbf{x}_{\xi},\quad \mathbf{a}_{\zeta}=\mathbf{x}_{\xi}\times\mathbf{x}_{\eta},
\end{equation}
thus the inverse matrix and determinant of the Jacobian matrix can be computed by the following formulas:
\begin{equation}
  |\mathbf{J}|(\xi,\eta,\zeta)=\mathbf{a}_{\xi}\cdot\mathbf{x}_{\xi},\quad
  [\mathbf{J}]^{-1}(\xi,\eta,\zeta)=\dfrac{1}{|\mathbf{J}|}\begin{bNiceMatrix}
    \mathbf{a}_{\xi}^{\mathrm{T}}\\
    \mathbf{a}_{\eta}^{\mathrm{T}}\\
    \mathbf{a}_{\zeta}^{\mathrm{T}}
  \end{bNiceMatrix}.
\end{equation}
...
At boundary elements we need to compute the value of the determinant of the Jacobian matrix; for interface integrals, the mapping of the Jacobian is different from that of volume integrals:
\begin{equation}
  [\mathbf{J}](\xi,\eta)=\dfrac{\partial(x,y,z)}{\partial(\xi,\eta)}=\begin{bNiceMatrix}
  ...
  \end{bNiceMatrix},\quad |\mathbf{J}|(\xi,\eta)=|\mathbf{x}_{\xi}\times\mathbf{x}_{\eta}|.
\end{equation}
