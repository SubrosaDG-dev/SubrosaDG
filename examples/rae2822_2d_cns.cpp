...
struct PhysicalModelData {
  ...
  // TransportModel
  static constexpr double kReynoldsNumber = 6.5e6;
  static constexpr double kDynamicViscosity = 1.4 * 0.4 * 1.0 / kReynoldsNumber;
...
inline const std::string kExampleName{"rae2822_2d_cns"};
