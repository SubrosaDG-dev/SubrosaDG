...
struct PhysicalModelData {
  ...
  // TransportModel
  static constexpr double kReynoldsNumber = 4000.0;
  static constexpr double kDynamicViscosity = 1.4 * 0.3 * 1.0 / kReynoldsNumber;
...
inline const std::string kExampleName{"delta_3d_cns"};
