...
using SimulationControl = SubrosaDG::SimulationControlNavierStokes<
    2, SubrosaDG::PolynomialOrderEnum::P1, SubrosaDG::MeshModelEnum::Quadrangle,
    ...
    SubrosaDG::TimeIntegrationEnum::ForwardEuler, SubrosaDG::ViewModelEnum::Vtu>;
...
int main(int argc, char* argv[]) {
  ...
  system.addInitialCondition("vc-1", []([[maybe_unused]] const Eigen::Vector<SubrosaDG::Real, 2>& coordinate) {
    return Eigen::Vector<SubrosaDG::Real, SimulationControl::kPrimitiveVariableNumber>{
        0.65, 0.4 * std::cos(SubrosaDG::toRadian(2.79)), 0.4 * std::sin(SubrosaDG::toRadian(2.79)), 1.0};
  });
  system.addBoundaryCondition<SubrosaDG::BoundaryConditionEnum::CharacteristicInflow>(
      "bc-1", {0.65, 0.4 * std::cos(SubrosaDG::toRadian(2.79)), 0.4 * std::sin(SubrosaDG::toRadian(2.79)), 1.0});
  system.addBoundaryCondition<SubrosaDG::BoundaryConditionEnum::PressureOutflow>(
      "bc-2", {0.65, 0.4 * std::cos(SubrosaDG::toRadian(2.79)), 0.4 * std::sin(SubrosaDG::toRadian(2.79)), 1.0});
