/**
 * @file explosion_2d_euler.cpp
 * @brief The source file for SubrosaDG example explosion_2d_euler.
 *
...
inline const std::string kExampleName{"explosion_2d_euler"};

inline const std::filesystem::path kExampleDirectory{SubrosaDG::kProjectSourceDirectory / "build/out" / kExampleName};

using SimulationControl = SubrosaDG::SimulationControlEuler<
    SubrosaDG::DimensionEnum::D2, SubrosaDG::PolynomialOrderEnum::P3, SubrosaDG::MeshModelEnum::Triangle,
...
int main(int argc, char* argv[]) {
  ...
  system.setMesh(kExampleDirectory / "explosion_2d_euler.msh", generateMesh);
  ...
  system.setArtificialViscosity(1.0_r, 4.0_r);
...
void generateMesh(const std::filesystem::path& mesh_file_path) {
  ...
  gmsh::model::addPhysicalGroup(2, physical_group_tag[1], -1, "vc-1");
